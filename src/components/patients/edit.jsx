            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="patientProfile">
                    ...
                    <div className="profile">
                        ...
                        <input id="room" type="text" placeholder="Room" {...register("Room", { required: true })} />
                        <label htmlFor="status">Status</label>
                        <input id="status" type="text" placeholder="Status" {...register("Status", { required: true })} />
                        <label htmlFor="condition">Condition</label>
                        <input id="condition" type="text" placeholder="Condition" {...register("Condition", { required: true })} />
                    </div>
                </div>
                ...
                <div className="patientInfo">
                    ...
                    <div className="Info">
                        <div className="leftInfo">
                            ...
                            <input id="age" type="number" placeholder="Age" {...register("Age", { required: true })} />
